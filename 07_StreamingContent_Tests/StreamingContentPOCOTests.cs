...
namespace _07_StreamingContent_Tests
{
    ...
    public class StreamingContentPOCOTests
    {
        ...
        {
            StreamingContent newContent = new StreamingContent("Back to the Future", "A high school student named Marty get accidenally dent back in time 30 years", 4.4, GenreType.SciFi, rating);
