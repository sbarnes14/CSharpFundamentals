...
namespace _08_Interfaces.Currency
{
    ...
    {
        //Withour a set or private set on value, we can only set value when making the object in a constructor 
        //With this constructoor we block the use of the empty constructor
